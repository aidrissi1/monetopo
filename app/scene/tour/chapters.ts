...
const CORE: LayerId[] = ["banking_core", "credit_flows"]; // banks + hub + boxes
...
export const TOUR: TourChapter[] = [
  ...
  },
  {
    ...
    copy:
      "Quand une banque accorde un prêt, elle crée le dépôt ex nihilo sur son propre bilan. Elle ne prête pas l'épargne des autres. Contre-intuitif — et pourtant documenté par la Bank of England (2014) et Werner (2014).",
    layers: [...CORE, "credit_flows"],
    focus: "hub",
  },
  {
    id: "deposits_return",
  ...
  },
  {
    ...
    title: "L'État",
    copy:
      "L'État prélève €297 B d'impôts + €155 B de cotisations, dépense €610 B. Le déficit de €52 B se finance par l'émission de nouveaux titres. La dette publique atteint €1 709 B — 101 % du PIB.",
    layers: [...CORE, "state", "bonds"],
    focus: "state",
  },
  {
    id: "ecb",
  ...
  },
  {
    ...
    title: "QE en direct",
    copy:
      "Regardez ce qui se passe quand la BCE imprime €100 B. Actifs + €100 B. Réserves + €100 B. Obligations ES + €10 B (10 % part Espagne). L'essentiel reste en réserves excédentaires — seuls quelques % deviennent du crédit réel.",
    layers: [...CORE, "ecb", "bonds", "state"],
    focus: "ecb",
    action: "fire_qe",
  },
  {
